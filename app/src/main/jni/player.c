...
Java_com_hawk_ffmpeg_FFmpeg_decoder(JNIEnv *env, jobject instance, jstring input_jstr, jstring output_jstr) {
    LOGI("welcome...");
    ...
    const char *output_str = (*env)->GetStringUTFChars(env, output_jstr, NULL);
